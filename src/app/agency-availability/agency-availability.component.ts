...
@Component({
  selector: 'app-agency-availability',
  templateUrl: './agency-availability.component.html',
  styleUrls: ['./agency-availability.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class agencyAvailabilityComponent implements OnInit {
  ...
  constructor(private dataService: DataService) {
    this.dataSource = this.dataService.getagencysData();
